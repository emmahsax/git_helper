...
If you're requesting to merge a pull request, the script will ask you the number ID of the pull request you wish to merge. The script will also default to squashing the pull request, and will ask you for verification. You can say 'yes' or 'no'. If you respond 'no', then provide either `merge` or `rebase` in order to use those types of merging. The commit message to use during the merge/squash will be the title of the pull request.
