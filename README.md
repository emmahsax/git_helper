...
If you're requesting to merge a pull request, the script will ask you the number ID of the pull request you wish to merge. The script will default to squashing the pull request, and ask you for verification. You can say 'yes' or 'no'. If you respond 'no',then provide either `merge` or `rebase` in order to use those types of merging.
